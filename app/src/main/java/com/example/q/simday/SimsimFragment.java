 ...
 * {@link SimsimFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SimsimFragment#newInstance} factory method to
...
public class SimsimFragment extends Fragment {
     ...
     * @return A new instance of fragment SimsimFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SimsimFragment newInstance(String param1, String param2) {
        SimsimFragment fragment = new SimsimFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_simsim, container, false);
        ...
        service.setUsernameAndPassword("38f4af07-ce7d-4201-9019-344deb792b01", "zhmUsXPM0Eop");
        ...
        Thread thread = new Thread(new Runnable(){
            public void run() {
                try {
                    ...
                    service.setUsernameAndPassword("72c02fec-c196-426f-9f76-cc76dd7ae0ee", "7meM1YcdVZjJ");

                    InputData input = new InputData.Builder(inputmessage).build();
                    MessageOptions options = new MessageOptions.Builder("737f432f-44d0-4638-9e34-f4182794f549").input(input).context(context).build();
    ...
    private void recordMessage() {
        ...
        speechService.setUsernameAndPassword("4fdd4c07-6ac8-420c-bcc1-595c9a628ff3", "HnjIROAaT3oE");
